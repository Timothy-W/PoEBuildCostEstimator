...
namespace BuildCostEstimator.Tests.XmlParserTests.ItemTests.TestData
{
    public class AffixModsParserTestData : IEnumerable<object[]>
    {
            ...
            yield return new object[]
            {
                    new ItemXmlHelper(
                        ...
                        XElement.Parse("	\t\t<Item id=\"23\">\r\nImplicits: 0\r\n+70 to maximum Life\r\n+35% to Fire Resistance\r\n+25% to Chaos Resistance\r\n{tags:attack,speed}{crafted}{range:1}(7-12)% increased Attack Speed\r\n-\r\nBudget items are typically just Life and Resists. Grab as much\r\nlife as you can on these items and what resists you need to have\r\n75%+ Elemental Resistances and 0%+ Chaos Resistance.\r\n\t\t\t<ModRange range=\"1\" id=\"4\"/>\r\n\t\t</Item>"))
            };
            ...
            yield return new object[]
                {
                    new ItemXmlHelper(
                        new Item
                        {
                            AffixMods = "[\"50% of Physical Damage Converted to Cold Damage\"]"
                        },
                        XElement.Parse(
            ...
            yield return new object[]
            {
                    new ItemXmlHelper(
                        new Item
                        {
                            AffixMods = "[\"Adds Knockback to Melee Attacks during Flask effect\"," +
                                        "\"75% chance to cause Enemies to Flee on use\"," +
                                        "\"23% more Melee Physical Damage during effect\"," +
            ...
            yield return new object[]
            {
                new ItemXmlHelper(
                    new Item
                    {
                        AffixMods = "[\"Immune to Curses during Flask effect\"," +
            ...
            yield return new object[]
            {
                new ItemXmlHelper(
                    new Item
                    {
                        AffixMods = "[\"Has 1 Socket\"," +
                                    "\"+8 to Level of Socketed Gems\"," +
                                    "\"+40% to Quality of Socketed Gems\"," +
                                    "\"Socketed Skills deal Double Damage\"," +
                                    "\"125% increased Armour and Evasion\"]"
            ...
            yield return new object[]
            {
                new ItemXmlHelper(
                    new Item
                    {
                        AffixMods = "[\"13% increased Quantity of Items found\"," +
                                    "\"Can't use other Rings\"," +
                                    "\"+20% to all Elemental Resistances\"," +
                                    "\"50% reduced Effect of Curses on You\"," +
                                    "\"+50 Life gained for each Enemy hit by your Attacks\"," +
            ...
            yield return new object[]
            {
                new ItemXmlHelper(
                    new Item
                    {
                        AffixMods = "[\"5% increased maximum Energy Shield\"," +
                                    "\"5% increased maximum Life\"," +
                                    "\"5% increased maximum Mana\"," +
                                    "\"+30 Life gained for each Enemy Hit while affected by Vitality\"]"
                    },
            ...
            yield return new object[]
            {
                new ItemXmlHelper(
                    new Item
                    {
                        AffixMods = "[\"+28 to Strength\",\"+60 to maximum Life\",\"30% increased Rarity of Items found\",\"+41% to Lightning Resistance\",\"30% increased Movement Speed\",\"5% increased Movement Speed if you haven't been Hit Recently\"]"
            ...
            yield return new object[]
            {
                new ItemXmlHelper(
                    new Item
                    {
                        AffixMods = "[\"+35 to all Attributes\"," +
            ...
            yield return new object[]
            {
                new ItemXmlHelper(
                    new Item
                    {
                        AffixMods = "[\"Implicit Modifier magnitudes are tripled\"]"

                    },
                    XElement.Parse("\t\t<Item variant=\"21\" id=\"20\">\r\n\t\t\tRarity: UNIQUE\r\nString of Servitude\r\nHeavy Belt\r\nLeague: Incursion\r\nVariant: Area of Effect\r\nVariant: Crit Multi during Flask Effect\r\nVariant: Attack Speed during Flask Effect\r\nVariant: Cast Speed during Flask Effect\r\nVariant: Crit Chance during Flask Effect\r\nVariant: Effect Duration\r\nVariant: Energy Shield\r\nVariant: Life\r\nVariant: Movement Speed during Flask Effect\r\nVariant: Item Rarity\r\nVariant: Item Quantity\r\nVariant: Wrath Aura Effect\r\nVariant: Anger Aura Effect\r\nVariant: Hatred Aura Effect\r\nVariant: Determination Aura Effect\r\nVariant: Discipline Aura Effect\r\nVariant: Grace Aura Effect\r\nVariant: Intelligence/Dexterity\r\nVariant: Dexterity/Strength\r\nVariant: Strength/Intelligence\r\nVariant: Elemental Resistances\r\nSelected Variant: 21\r\nHeavy Belt\r\nLevelReq: 8\r\nImplicits: 24\r\n{variant:1}{range:0.5}(24-30)% increased Area of Effect\r\n{tags:critical}{variant:2}{range:0.5}+(60-75)% to Critical Strike Multiplier during any Flask Effect\r\n{tags:speed}{variant:3}{range:0.5}(24-36)% increased Attack Speed during any Flask Effect\r\n{tags:speed}{variant:4}{range:0.5}(24-36)% increased Cast Speed during any Flask Effect\r\n{tags:critical}{variant:5}{range:0.5}(105-120)% increased Critical Strike Chance during any Flask Effect\r\n{variant:6}{range:0.5}(36-45)% increased Skill Effect Duration\r\n{variant:7}{range:0.5}(24-30)% increased maximum Energy Shield\r\n{variant:8}{range:0.5}(18-24)% increased maximum Life\r\n{tags:speed}{variant:9}{range:0.5}(24-36)% increased Movement Speed during any Flask Effect\r\n{variant:10}{range:0.5}(60-90)% increased Rarity of Items found\r\n{variant:11}{range:0.5}(9-15)% increased Quantity of Items found\r\n{variant:12}{range:0.5}Wrath has (45-60)% increased Aura Effect\r\n{variant:13}{range:0.5}Anger has (45-60)% increased Aura Effect\r\n{variant:14}{range:0.5}Hatred has (45-60)% increased Aura Effect\r\n{variant:15}{range:0.5}Determination has (45-60)% increased Aura Effect\r\n{variant:16}{range:0.5}Discipline has (45-60)% increased Aura Effect\r\n{variant:17}{range:0.5}Grace has (45-60)% increased Aura Effect\r\n{variant:18}{range:0.5}(12-18)% increased Intelligence\r\n{variant:18}{range:0.5}(12-18)% increased Dexterity\r\n{variant:19}{range:0.5}(12-18)% increased Dexterity\r\n{variant:19}{range:0.5}(12-18)% increased Strength\r\n{variant:20}{range:0.5}(12-18)% increased Strength\r\n{variant:20}{range:0.5}(12-18)% increased Intelligence\r\n{tags:jewellery_resistance}{variant:21}{range:1}+(42-48)% to all Elemental Resistances\r\nImplicit Modifier magnitudes are tripled\r\nCorrupted\r\n\t\t\t<ModRange range=\"0.5\" id=\"1\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"2\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"3\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"4\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"5\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"6\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"7\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"8\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"9\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"10\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"11\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"12\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"13\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"14\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"15\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"16\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"17\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"18\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"19\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"20\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"21\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"22\"/>\r\n\t\t\t<ModRange range=\"0.5\" id=\"23\"/>\r\n\t\t\t<ModRange range=\"1\" id=\"24\"/>\r\n\t\t</Item>"))
            };
